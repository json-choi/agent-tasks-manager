...
const ko: Record<string, string> = {
  ...
  "Create Task": "태스크 생성",
  "Create task": "태스크 생성",
  "Add focused work directly to the selected board lane.": "선택한 보드 레인에 집중 작업을 바로 추가합니다.",
  "Task title": "태스크 제목",
  "Create task for": "태스크 생성 대상",
  "Create task in": "태스크 생성 위치",
  "Task scope": "태스크 범위",
  "Task lane": "태스크 레인",
  "Lane": "레인",
  "Cancel": "취소",
  ...
  "No assigned tasks": "배정된 태스크 없음",
  "No tasks": "태스크 없음",
  "Drop here": "여기에 놓기",
  "Choose detailed status": "세부 상태 선택",
  "Save drop": "드롭 저장",
  "Saving...": "저장 중...",
  "drop zone": "드롭 영역",
  "Unassigned": "미지정",
  ...
  "Mention filters": "멘션 필터",
  "Remove mention filter": "멘션 필터 제거",
  "No mention filters configured.": "설정된 멘션 필터가 없습니다.",
  "Known Slack users": "알려진 Slack 사용자",
  "Select a user": "사용자 선택",
  "No mapped Slack users": "매핑된 Slack 사용자 없음",
  "Add user": "사용자 추가",
  "Manual mention": "수동 멘션",
  "Add mention": "멘션 추가",
  "inactive": "비활성",
  ...
  "Install the OpenClaw integration.": "OpenClaw 연동을 설치합니다.",
  "OpenClaw Integration": "OpenClaw 연동",
  ...
  "Install OpenClaw before continuing.": "계속하기 전에 OpenClaw를 설치하세요.",
  "OpenClaw integration is installed.": "OpenClaw 연동이 설치되었습니다.",
  ...
  "Checking session...": "세션을 확인하는 중...",
  "Loading...": "불러오는 중...",
  "Task": "태스크",
  "All members": "전체 멤버",
  "Filter by member": "멤버로 필터",
  "Owner": "소유자",
  "Source": "출처",
  "All sources": "전체 출처",
  "Filter by source": "출처로 필터",
  "All priorities": "전체 우선순위",
  "Filter by priority": "우선순위로 필터",
  "No tasks need attention in this view.": "이 화면에서 주의가 필요한 태스크가 없습니다.",
  "No activity yet.": "아직 활동이 없습니다.",
  "On": "켜짐",
  "Off": "꺼짐",
  "Production": "운영",
  "Quick preview": "빠른 미리보기",
  "cloudflared": "cloudflared",
  "Installed": "설치됨",
  "Provided": "제공됨",
  "yes": "예",
  "no": "아니요",
  "Paste a token and save to generate this command.": "토큰을 붙여넣고 저장하면 이 명령이 생성됩니다.",
  "Health status": "헬스 상태",
  "Add a public URL first.": "먼저 공개 URL을 추가하세요.",
  "Public access settings saved.": "공개 접근 설정이 저장되었습니다.",
  "Settings saved. Add the Cloudflare public hostname when ready.": "설정이 저장되었습니다. 준비되면 Cloudflare 공개 호스트명을 추가하세요.",
